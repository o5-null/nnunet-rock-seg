...
class nnUNetTrainerLightMamba2Net(nnUNetTrainer_MedNeXtBase):
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        # nnUZoo 原版超参（对应 nnUZoo nnUNetTrainerLightMamba2Net.__init__）
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print(f"LightMamba2Net built. Trainable parameters: {sum(p.numel() for p in model.parameters() if p.requires_grad):,}")
        return model
