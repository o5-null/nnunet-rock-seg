...
from nnunetv2.nets.unetr2net import UNETR2Net
import torch
...
class nnUNetTrainerUNETR2Net(nnUNetTrainer_MedNeXtBase):
    """
    UNETR2Net: UNETR 2nd Generation (X2Net series member)
    """
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        # nnUZoo 原版超参（对应 nnUZoo nnUNetTrainerUNETR2Net.__init__）
