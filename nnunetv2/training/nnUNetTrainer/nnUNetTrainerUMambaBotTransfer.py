"""
UMambaBot 迁移学习训练器
基于 TransferLearningBase mixin 实现，继承自本 fork 的 UMambaBot Trainer
"""
...
class nnUNetTrainerUMambaBotTransfer(nnUNetTrainerUMambaBot, TransferLearningBase):
    """
    UMambaBot 迁移学习训练器
    多继承: UMambaBot + TransferLearningBase
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self._print_transfer_config("UMambaBot Transfer Learning")
    ...
    def run_training(self):
        """运行训练"""
        self.print_to_log_file("Starting UMambaBot Transfer Learning training")
        start = time.time()
...
class nnUNetTrainerUMambaBotTransfer_100epochs(nnUNetTrainerUMambaBotTransfer):
    """100 轮版本的 UMambaBot 迁移学习训练器"""
