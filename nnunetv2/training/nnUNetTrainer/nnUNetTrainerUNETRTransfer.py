"""
UNETR 迁移学习训练器
多继承 nnUNetTrainerUNETR + TransferLearningBase
"""
...
class nnUNetTrainerUNETRTransfer(nnUNetTrainerUNETR, TransferLearningBase):
    """UNETR 迁移学习训练器 — 渐进解冻 + Tversky Loss"""
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self._print_transfer_config("UNETR Transfer Learning")
    ...
    def run_training(self):
        """运行训练"""
        self.print_to_log_file("Starting UNETR Transfer Learning training")
        start = time.time()
...
class nnUNetTrainerUNETRTransfer_100epochs(nnUNetTrainerUNETRTransfer):
    """100 轮版本的 UNETR 迁移学习训练器"""
