...
class nnUNetTrainerLightSS2DMambaUNet(nnUNetTrainer_MedNeXtBase):
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        # 根因: fp16 只有 5 位指数（动态范围约 6e-5 .. 65504），Mamba 系 SSM 的指数运算 的
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        print(f"LightSS2DMambaUNet built. Trainable parameters: {sum(p.numel() for p in model.parameters() if p.requires_grad):,}")
        return model
