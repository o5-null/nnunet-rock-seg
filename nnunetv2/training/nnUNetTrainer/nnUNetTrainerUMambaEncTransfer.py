"""
UMambaEnc 迁移学习训练器
基于 TransferLearningBase mixin 实现，继承自本 fork 的 UMambaEnc Trainer
"""
...
class nnUNetTrainerUMambaEncTransfer(nnUNetTrainerUMambaEnc, TransferLearningBase):
    """
    UMambaEnc 迁移学习训练器
    多继承: UMambaEnc + TransferLearningBase
    """
    ...
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        self._print_transfer_config("UMambaEnc Transfer Learning")
    ...
    def run_training(self):
        """运行训练"""
        self.print_to_log_file("Starting UMambaEnc Transfer Learning training")
        start = time.time()
...
class nnUNetTrainerUMambaEncTransfer_100epochs(nnUNetTrainerUMambaEncTransfer):
    """100 轮版本的 UMambaEnc 迁移学习训练器"""
