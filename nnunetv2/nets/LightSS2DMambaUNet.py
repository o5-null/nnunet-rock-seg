...
class MambaLayer(nn.Module):
    def __init__(self, input_dim, output_dim, d_state=16, d_conv=4, expand=2):
        ...
        self.mamba = SS2D(
            ...
            # ssm_ratio=ssm_ratio,  # Block expansion factor
        )
...
#     patch_size = [256, 256]
#     out_ch = 5
#     model = LightSS2DMambaUNet(spatial_dims=2, init_filters=32, in_ch=in_ch, out_ch=out_ch)
#     summary(model, input_size=[1, in_ch, *patch_size])
#
#     output = model(torch.rand((1, in_ch, *patch_size)).to("cuda:0"))
#     print(output.shape)
